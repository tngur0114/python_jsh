...
class GalagaGame():
    ...
    def __init__(self, master):
        ...
        master.bind("<Escape>", self.keyESCs)
        master.bind("<Return>", self.startGame)

        self.shot_sount = pygame.mixer.Sound('shot_sound.mp3')
        self.start_sound = pygame.mixer.Sound('start_sound.mp3')

...
class GalagaGame():
    ...
    def __init__(self, master):
        ...
        self.canvas.pack()
        # 이미지 생성
        self.alienImage = PhotoImage(r"D:\python J\alien.png")
        self.shotImage = PhotoImage(r"D:\python J\fire.png")
        self.shipImage = PhotoImage(r"D:\python J\starship.png")
        # 게임실행 여부 & sprite 초기화
        self.running = True
        self.initSprites()
        # 이벤트 처리(7가지 이벤트 처리)
    ...
    def startGame(self, event):
        ...
        self.initSprites()          # sprites 객체 초기화

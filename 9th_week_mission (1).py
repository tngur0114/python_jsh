...
'''
numbers1 = (1, 5, 6, 81, 86)             # ()로 튜플 만들기
numbers2 = 1, 51, 4561,True             # ()없이 튜플 만들기
...
def character_info(name, attack, health, speed):
    ...
    print(f"기본 공격력: {speed}")



character1_name = '아리'
character1_attack = 53
character1_health = 516
character1_speed = 330
...
character2_name = '키아나'
character2_attack = 66
character2_health = 590
character2_speed = 335
...
Ahri = character("아리",53, 516, 330 )
Quiana = character("키아나", 66, 590, 335)

Ahri.character_info()
Quiana.character_info()

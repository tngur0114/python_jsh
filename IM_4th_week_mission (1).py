...
win = Tk()
win.title("Canvas 도형 그리기 연습문제")

c = Canvas(win, width=600, height=400)
c.pack()
c.create_oval(28, 18, 150, 100, width=5, outline="silver", fill="gold")
c.create_line(0, 0, 250, 200, width=9, fill="green")
c.create_rectangle(50, 150, 150, 300, width=4, outline="black", fill="purple")
...
win = Tk()
win.title("Canvas로 이미지 출력하기")

c = Canvas(win, width=600, height=400)
c.pack()
img = PhotoImage(file="D:\python J\img (1).png")
...
class Application:
    def __init__(self, parent):   #parent를 root로 바꿔줘도 된다. parent = root
